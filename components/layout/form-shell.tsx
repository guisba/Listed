  ...
  return (
    <main className="min-h-screen bg-background">
      <header className="border-b border-border">
        <div className="compact-320 mx-auto flex h-16 max-w-[var(--content-max)] items-center justify-between px-4 sm:px-6"><ListedLogo /><ThemeSwitcher /></div>
      </header>
      <div className={`compact-320 mx-auto grid max-w-[var(--content-max)] gap-8 px-4 py-8 sm:px-6 sm:py-12 lg:items-start lg:gap-14 ${wide ? "lg:grid-cols-[.7fr_1.3fr]" : "lg:grid-cols-[.85fr_1.15fr]"}`}>
        <section className="lg:sticky lg:top-28">
          ...
          <div className="mt-8 hidden border-t border-border pt-5 text-xs leading-5 text-muted-foreground lg:block">Sem cadastro obrigatório para listas rápidas.<br />Sua identidade temporária fica neste navegador.</div>
        </section>
